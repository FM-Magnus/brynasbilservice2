...
test('bilbatteri page renders without horizontal overflow across breakpoints', async ({ page }, testInfo) => {
  await page.goto('/bilbatteri')
  ...
  await expect(h1).toContainText('Bilbatteri')
  ...
  await page.screenshot({
    path: testInfo.outputPath(`bilbatteri-${testInfo.project.name}.png`),
    fullPage: true,
  })
})
