...
test('stodampare page renders without horizontal overflow across breakpoints', async ({ page }, testInfo) => {
  await page.goto('/stodampare-fjadrar')
  ...
  await page.screenshot({
    path: testInfo.outputPath(`stodampare-${testInfo.project.name}.png`),
    fullPage: true,
  })
})
