      ...
      <div className="px-4 py-5 sm:px-6">
        <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
          ...
          <button
            ...
            className="inline-flex items-center px-4 py-2 border border-transparent text-sm font-medium rounded-md shadow-sm text-white bg-indigo-600 hover:bg-indigo-700 dark:bg-[var(--bb-color-teal-600)] dark:hover:bg-[var(--bb-color-teal-700)] focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500"
          >
            {t('addNewService')}
          </button>
        </div>
                    ...
                    <tr key={service.id} onClick={() => openModal(service)} className="cursor-pointer hover:bg-gray-100 dark:hover:bg-brynas-dark-3">
                      ...
                      <td className="px-6 py-4 whitespace-nowrap text-sm font-medium">
                        ...
                        <button
                          ...
                          className="text-indigo-600 hover:text-indigo-900 dark:text-[var(--bb-color-teal-600)] dark:hover:text-[var(--bb-color-teal-700)] mr-4"
                          title={t('editService')}
                        >
