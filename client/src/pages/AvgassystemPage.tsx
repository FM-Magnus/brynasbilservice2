    ...
    <>
      ...
      <main className="services-page exhaust-page">
        ...
        <section className="services-page__guide exhaust-page__intro" aria-labelledby="exhaust-intro-title"><div className="container">
          ...
          <div className="exhaust-page__parts-timeline">{parts.map(([title, text]) => <article className="exhaust-page__part-card exhaust-page__part-card--timeline" key={title}><span className="exhaust-page__part-dot" aria-hidden="true" /><h3>{title}</h3><p>{text}</p></article>)}</div>
