          ...
          <div className="container">
            <div className="services-page__hero-content">
              ...
              <h1 className="services-page__title" id="services-hero-title">
                Service & <span className="title-accent">Reparationer</span>
              </h1>
              <p className="services-page__lead">
                Som märkesoberoende bilverkstad i Gävle erbjuder vi komplett bilservice, avancerad felsökning och mekaniska reparationer för alla bilmärken. Du får alltid personlig kontakt, fast överenskommelse och tydlig återkoppling innan vi utför något arbete.
              </p>
        ...
        <section className="services-page__categories" aria-labelledby="services-categories-title">
          <div className="container">
            <header className="section-header">
              <div className="section-eyebrow">
                <span className="eyebrow-line" aria-hidden="true" />
                Bilservice & Felsökning
              </div>
              <h2 className="section-title" id="services-categories-title">
                Service & <span className="title-accent">Mekaniska Arbeten</span>
              </h2>
              <p className="section-desc">
                Här hittar du detaljerad information om vad vi utför inom bilservice och felsökning, vilka vanliga symptom vi åtgärdar och hur du enkelt bokar din verkstadstid.
              </p>
            </header>
