...
import './StodampareFjadrarPage.css'
    ...
    <>
      ...
      <main className="services-page suspension-page">
        ...
        <section className="services-page__guide suspension-page__intro" aria-labelledby="suspension-intro-title"><div className="container">
          ...
          <div className="suspension-page__parts-stack">{parts.map(([title, text], index) => <article className="suspension-page__part-card suspension-page__part-card--stack" style={{ '--stack-index': index } as CSSProperties} key={title}><h3>{title}</h3><p>{text}</p></article>)}</div>
