...
- Committed as `afda8cee` on `redesign/blue-teal-v1` ("feat(pages): rework Bilbatteri, Felsokning, AC, Dackservice pages + site-wide hero rule"), on Magnus's explicit request. **Not pushed** — never push without Magnus's prior approval.
