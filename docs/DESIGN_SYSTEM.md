...
### 2c. Hero geometry (steps 1 and 2 done 2026-09-20)
...
- **Status at 1280x720 after steps 1-2 (hero as % of screen height):** Kontakt 72, Bärgning 78, Bilservice 82, Hjullager 87, Home 89, Stödämpare 90, Bilar till salu 90, Däckservice 91, Bilbatteri 92, Felsökning 94, Styrning 94, Drivaxel 96, Om oss 98, Koppling 101, Avgassystem 101, Bromssystem 103, Kamrem 105, Oljebyte 105, AC-service 125. Target for the Standard type is 85%; not yet met.
- **Open:** step 3, a compact trust row for the guides (the lever the guides need); AC-service (CTA row and lead wrap, an outlier); Om oss, Kamrem and Bilar till salu are set by their image or side column, not the text; mobile hero tokens are unchanged; the phone-button label has six copy variants (copy decision).
