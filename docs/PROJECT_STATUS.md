...
| Biltjänster → Kamrem | `/kamrem` | Empty destination shell awaiting the page-specific content pass | No draft copy inserted | Marked hero image placeholder | Distribute and review supplied Kamrem draft copy; provide a hero image |
...
| Biltjänster → Bilbatteri | `/bilbatteri` | Empty destination shell awaiting the page-specific content pass | No draft copy inserted | Marked hero image placeholder | Distribute and review supplied Bilbatteri draft copy; provide a hero image |
| Biltjänster → Stötdämpare och fjädrar | `/stodampare-fjadrar` | Empty destination shell awaiting the page-specific content pass | No draft copy inserted | Marked hero image placeholder | Distribute and review supplied draft copy; provide a hero image |
| Biltjänster → Hjullagerbyte | `/hjullagerbyte` | Empty destination shell awaiting the page-specific content pass | No draft copy inserted | Marked hero image placeholder | Distribute and review supplied draft copy; provide a hero image |
| Biltjänster → Avgassystem | `/avgassystem` | Empty destination shell awaiting the page-specific content pass | No draft copy inserted | Marked hero image placeholder | Distribute and review supplied draft copy; provide a hero image |
| Biltjänster → Drivaxel och drivknutar | `/drivaxel-drivknutar` | Empty destination shell awaiting the page-specific content pass | No draft copy inserted | Marked hero image placeholder | Distribute and review supplied draft copy; provide a hero image |
| Biltjänster → Styrning och kulleder | `/styrning-kulleder` | Empty destination shell awaiting the page-specific content pass | No draft copy inserted | Marked hero image placeholder | Distribute and review supplied draft copy; provide a hero image |
...
| Däck | `/dackservice` | Implemented tyre service, prices and advice | WIP; not approved | One local JPG reused as marked placeholder | Supply service-specific photos and confirm copy/prices |
| AC | `/ac-service` | Implemented AC-service page | WIP; not approved | Local service JPG | Confirm copy and photo selection |
